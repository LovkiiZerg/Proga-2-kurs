...
public:
    ...
    bool createTables();
    bool insertClient(const std::string& name, int calls, float basePrice, int tarifType);
    bool updateClient(int id, const std::string& name, int calls, float basePrice, int tarifType);
    bool deleteClient(int id);
    bool getAllClients(std::vector<std::unique_ptr<TarifStrategy>>& tarifs);
    bool clearTable();
